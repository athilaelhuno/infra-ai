...
terraform {
  source = "file:///Users/efermin/aaxis/AI/agents/infra/infraestructura/modules/gcp/buckets"
  ...
  extra_arguments "backend_config" {
    ...
    arguments = [
      ...
      "-backend-config=prefix=adriana/gcp/qa/buckets/adriana_bucket_test_03"
    ]
  }
}
